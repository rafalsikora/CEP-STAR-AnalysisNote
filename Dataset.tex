...
\end{enumerate}%
Components used in definitions of all diffractive triggers are outlined in Fig.~\ref{fig:triggerBits}. Detailed explanation of all trigger bits can be found in Refs.~\cite{RpTriggers,RpTriggers2}.

Main RP triggers which were intended for usage in diffractive physics analyses or efficiency studies are listed in Tab.~\ref{tab:triggers}. ~\cite{Luminosity} ~\cite{onlineRpTriggersMonitoring} ~\cite{Labeling}

\begin{figure}[h]
 \centering%
 \includegraphics[width=0.7\linewidth]{graphics/dataset/bits.png}%
...
\begin{table}[h!]\centering
 ...
 RP\_CP & {EOR \&\& WOR} & 73.3 (46.0) & \specialcell{Very loose trigger (mostly elastic events)\\ designed for monitoring/trigger efficiency study}\\ \hline
 ...
 RP\_CPX & {\specialcell{\specialcell{IT\\ \&\& !BBCE \&\& !BBCW} \\ \specialcell{\&\& !ZDCE \&\& !ZDCW} \\ \&\& TOF$\geq$2}} & 40.1 (0.0) & The same as RP\_CPT2 but only IT configuration\\ \hline
