...
\begin{enumerate}[label=\textbf{C\arabic*},ref=C\arabic*]
 ...
 \itemm Exactly 2 opposite-sign primary TPC tracks~(\ref{enum:TpcOppoSign}) of good quality~(\ref{enum:TpcQualityCuts}) matched with hits in TOF~(\ref{enum:TpcTofMatched}), reconstructed within kinematic region of high TPC acceptance~(\ref{enum:TpcKinematicCuts}) and with small distance of closest approach (DCA) to the vertex~(\ref{enum:TpcDcaCuts}).\label{enum:CutTpcTrks}
    \begin{enumerate}[label=\textbf{\theenumi.\arabic*},ref=\theenumi.\arabic*]
      ...
      $N_{\text{hits}}^{\text{fit}}\geq25$,~~~~$N_{\text{hits}}^{\text{dE/dx}}\geq15$,~~~~$|d_{0}|<1.5$~cm,%~~~~$|z_{0}|<200$~cm,
 ...
 \textbf{~~if~~} $n\sigma_{\text{pion}}^{\text{pair}}>3$ \textbf{~~\&~~} $n\sigma_{\text{kaon}}^{\text{pair}}>3$ \textbf{~~\&~~} $n\sigma_{\text{proton}}^{\text{pair}}<3$ \textbf{~~\&~~} $m^{2}_{\text{TOF}}>0.6~\text{GeV}/c^{2}~~\rightarrow~~pp$\\%
\textbf{elif~~} $n\sigma_{\text{pion}}^{\text{pair}}>3$ \textbf{~~\&~~} $n\sigma_{\text{kaon}}^{\text{pair}}<3$ \textbf{~~\&~~} $n\sigma_{\text{proton}}^{\text{pair}}>3$ \textbf{~~\&~~} $m^{2}_{\text{TOF}}>0.15~\text{GeV}/c^{2}~~\rightarrow~~KK$\\%
\textbf{elif~~} $|n\sigma_{\text{pion}}^{\text{trk1}}|<3$ \textbf{~~\&~~} $|n\sigma_{\text{pion}}^{\text{trk2}}|<3~~\rightarrow~~\pi\pi$\\%
