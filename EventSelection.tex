...
\parbox{0.475\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:NTofClusters_linear}}{\includegraphics[width=\linewidth]{graphics/eventSelection/Ratio_Linear_NTofClusters.pdf}}}
  \end{subfigure}
}
\quad
\parbox{0.475\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:NTofClusters_log}}{\includegraphics[width=\linewidth]{graphics/eventSelection/Ratio_NTofClusters.pdf}}}
  \end{subfigure}
}%
