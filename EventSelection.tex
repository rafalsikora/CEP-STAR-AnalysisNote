...
\parbox{0.475\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:TofClusterHitDistance_Space}}{\includegraphics[width=\linewidth]{graphics/eventSelection/TofClusterHitDistance_Space.pdf}}}
  \end{subfigure}
}
\quad
\parbox{0.475\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:TofClusterHitDistance_Time}}{\includegraphics[width=\linewidth]{graphics/eventSelection/TofClusterHitDistance_Time.pdf}}}
  \end{subfigure}
}\vspace*{-10pt}%
\caption[Distribution of space and time distance between TOF hits and existing TOF clusters.]{Distribution of space~(\subref{fig:TofClusterHitDistance_Space}) and time~(\subref{fig:TofClusterHitDistance_Time}) distance between TOF hits and existing TOF clusters in the clustering procedure. Each of distributions contains entries from cluster-hit pairs satisfying matching requirement imposed on the other quantity. Data are shown as black points with vertical error bars representing statistical uncertainties and horizontal bars representing bin sizes. Expectations from embedded $\pi^{+}\pi^{-}$ signal MC, normalized to the same integrals at $R>0.5$~(\subref{fig:TofClusterHitDistance_Space}) or at $\Delta t>2$~ns~(\subref{fig:TofClusterHitDistance_Time}), has also been shown. Dashed red lines mark limits used in the TOF clustering algorithm.}\label{fig:TofClusterHitDistance}
\end{figure}%
%---------------------------
...
\parbox{0.475\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:NTofClusters_linear}}{\includegraphics[width=\linewidth]{graphics/eventSelection/Ratio_Linear_NTofClusters.pdf}\vspace*{-10pt}}}
  \end{subfigure}
}
\quad
\parbox{0.475\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:NTofClusters_log}}{\includegraphics[width=\linewidth]{graphics/eventSelection/Ratio_NTofClusters.pdf}\vspace*{-10pt}}}
  \end{subfigure}
}%
