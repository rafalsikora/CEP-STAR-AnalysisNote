...
\parbox{0.31\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}
                \subcaptionbox{\label{fig:localAngle2D_X}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_x_E1U.pdf}\vspace*{-10pt}}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{1}
                \subcaptionbox{\label{fig:localAngle1D_X}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_x_W2U.pdf}}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{1}
                \subcaptionbox{\label{fig:localAngle1D_X}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_x_W1D.pdf}}
  \end{subfigure}
}%
\quad%
\parbox{0.31\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{-2}
                \subcaptionbox{\label{fig:localAngle2D_Y}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_x_E2U.pdf}\vspace*{-10pt}}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{1}
                \subcaptionbox{\label{fig:localAngle1D_Y}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_x_E1D.pdf}}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{1}
                \subcaptionbox{\label{fig:localAngle1D_X}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_x_W2D.pdf}}
  \end{subfigure}
}%
\quad%
\parbox{0.31\textwidth}{
  ...
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{-2}
                \subcaptionbox{\label{fig:localAngle2D_Y}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_x_W1U.pdf}\vspace*{-10pt}}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{1}
                \subcaptionbox{\label{fig:localAngle1D_Y}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_x_E2D.pdf}}
  \end{subfigure}
...
\parbox{0.31\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}
                \subcaptionbox{\label{fig:localAngle2D_X}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_y_E1U.pdf}\vspace*{-10pt}}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{1}
                \subcaptionbox{\label{fig:localAngle1D_X}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_y_W2U.pdf}}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{1}
                \subcaptionbox{\label{fig:localAngle1D_X}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_y_W1D.pdf}}
  \end{subfigure}
}%
\quad%
\parbox{0.31\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{-2}
                \subcaptionbox{\label{fig:localAngle2D_Y}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_y_E2U.pdf}\vspace*{-10pt}}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{1}
                \subcaptionbox{\label{fig:localAngle1D_Y}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_y_E1D.pdf}}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{1}
                \subcaptionbox{\label{fig:localAngle1D_X}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_y_W2D.pdf}}
  \end{subfigure}
}%
\quad%
\parbox{0.31\textwidth}{
  \centering\vspace*{-22pt}
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{-2}
                \subcaptionbox{\label{fig:localAngle2D_Y}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_y_W1U.pdf}\vspace*{-10pt}}
  \end{subfigure}\\
  \begin{subfigure}[b]{\linewidth}\addtocounter{subfigure}{1}
                \subcaptionbox{\label{fig:localAngle1D_Y}}{\includegraphics[width=\linewidth]{graphics/eventSelection/RpTracks/Ratio_Linear_y_E2D.pdf}}
  \end{subfigure}
    \begin{minipage}[t][1.042\linewidth][t]{\linewidth}\end{minipage}
}
\label{fig:yRp}%
