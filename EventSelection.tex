...
\end{equation}
Per event no more than 1 additional TOF cluster was allowed, thus in total the number of reconstructed TOF clusters $N^{\text{TOF}}_{\text{cltrs}}$ could not exceed 3.
...
\caption[...]{...}\label{fig:TofClusterHitDistance}
\end{figure}%
%---------------------------
...
\caption[...]{...}\label{fig:NTofClusters}
\end{figure}%
%---------------------------
