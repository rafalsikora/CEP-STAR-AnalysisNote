...
% w obszarze wspólnym z analizą elastyczna stosunek N/lumi = 5.40 +- 0.16
% 
% W całym zakresie
% 
% N/lumi = 5.15
% 
% 
% Co daje zmianę (0.25+-0.15) /5  =  5 +- 3 %
% 
% 
% Mozna dać oszacowanie mało konserwatywne i stwierdzić że różnica 5 + - 3
% nie jest
% znacząca i przyjąć bład statystyczny 3% jako dodatkowy błąd na lumi.
% Czyli całkowity błąd sqrt(16+9) = 5 %
% 
% Można być bardziej ostrożnym i przyjąć 5% jako dodatkowy błąd na
% nrmalizację:
% 
% 
% Czyli całkowity błąd sqrt(16+25) = 7 %
...
%
\caption{Result of variation of the TPC track quality cuts on the fiducial differential exclusive $\pi^{+}\pi^{-}$ production cross-section as a function of the invariant mass of pion pair.}
