...
\parbox{0.4725\textwidth}{
  ...
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:dEdxMeanOffsetMC}}{\includegraphics[width=\linewidth]{graphics/corrections/dEdxMeanOffset_allPIDs.pdf}}}
  \end{subfigure}
}
\quad
\parbox{0.4725\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:dEdxWidthMC}}{\includegraphics[width=\linewidth]{graphics/corrections/dEdxWidth_allPIDs.pdf}}}
  \end{subfigure}
}%
\caption[Parameters of track dE/dx as a function of reconstructed momentum for a few particle species (STARsim MC).]{Difference between MPV of dE/dx predicted by Bichsel parametrization and obtained from the fit of Eq.~\eqref{eq:expTail} to dE/dx distribution from MC sample (\ref{fig:dEdxMeanOffsetMC}) and dE/dx width parameter (\ref{fig:dEdxWidthMC}) as a function of reconstructed particle momentum for a few particle species. Solid lines represent fits to points of corresponding color.}\label{fig:dEdxParametersMC}
\end{figure}
%---------------------------
...
\begin{table}[ht!]\centering
 ...
 $\bm{e^{\pm}}$ & \scriptsize-1.483e-7 & \scriptsize3.710e-7 & \scriptsize5.639 & \scriptsize& \scriptsize& \scriptsize& \scriptsize0.0590 & \scriptsize-0.009 & \scriptsize-194.421 & \scriptsize-1.81e-3 & \scriptsize26.392 & \scriptsize0.607 \\ \hline
