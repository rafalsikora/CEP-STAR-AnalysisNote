...
\begin{figure}[h]
  ...
  \begin{tabular}{@{}p{0.49\linewidth}@{\quad}p{0.49\linewidth}@{}} 
    ...
    \subfigimg[width=\linewidth,page=1]{~~~~~~~~~~c)}{graphics/corrections/FullCorrectionValidation_NoMatchingRequired_EffUsingRecoValues_MandelstamTSum.pdf} &
    \subfigimg[width=\linewidth,page=1]{~~~~~~~~~~d)}{graphics/corrections/FullCorrectionValidation_NoMatchingRequired_EffUsingRecoValues_DeltaPhi.pdf}
  \end{tabular}
