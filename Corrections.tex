...
\begin{figure}[t!]\label{fig:pidEffVsPt}
  \centering
...
The identification efficiency and misidentification probability was calculated for each species using the pair selection cuts~\ref{enum:CutPidNoPtLimit} described in more detail in Sec.~\ref{subsec:pidCuts}, following the definition provided in the Eq.~():
