...
\parbox{0.4725\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:migrationPtEta}}{\includegraphics[width=\linewidth]{graphics/corrections/Migrations_PtEta.pdf}}}
  \end{subfigure}
}
\quad
\parbox{0.4725\textwidth}{
  \centering
  \begin{subfigure}[b]{\linewidth}{
                \subcaptionbox{\label{fig:migrationPxPy}}{\includegraphics[width=\linewidth]{graphics/corrections/Migrations_PxPy.pdf}}}
  \end{subfigure}
}% 
\caption[...]{.} \label{fig:migrationsCorrections}
\end{figure} 
...
Sanity of the data after applied corrections was verified by preparing a pull histogram of the number of reconstructed events per unit of integrated luminosity. The pull quantity was calculated per run, defined as 
\begin{equation}\label{eq:pull}
 \text{Pull}_{i} = \frac{N_{i}/L_{i}-\langle N/L\rangle}{\sigma_{i}/L_{i}},
\end{equation}
where $N_{i}$ is a number of events in $i$-th run, $\sigma_{i}$ is a statistical uncertainty of $N_{i}$, $L_{i}$ is a luminosity collected during $i$-th run and $\langle N/L\rangle$ is expected number of events per unit of integrated luminosity. The latter is calculated using an estimator from Eq.~\eqref{eq:estimatorNL}:
\begin{equation}\label{eq:estimatorNL}
 \langle N/L\rangle = \frac{\sum\limits_{i}N_{i}}{\sum\limits_{i}L_{i}}.
\end{equation}
...
\begin{figure}[h]
  \centering
  \begin{tabular}{@{}p{0.49\linewidth}@{\quad}p{0.49\linewidth}@{}}
    \subfigimg[width=\linewidth,page=1]{~~~~~~~~~~a)}{graphics/corrections/FullCorrectionValidation_EffUsingRecoValues_InvMass.pdf} &
    \subfigimg[width=\linewidth,page=1]{~~~~~~~~~~b)}{graphics/corrections/FullCorrectionValidation_EffUsingRecoValues_Rapidity.pdf} \\
    \subfigimg[width=\linewidth,page=1]{~~~~~~~~~~d)}{graphics/corrections/FullCorrectionValidation_EffUsingRecoValues_MandelstamTSum.pdf} &
    \subfigimg[width=\linewidth,page=1]{~~~~~~~~~~e)}{graphics/corrections/FullCorrectionValidation_EffUsingRecoValues_DeltaPhi.pdf}
  \end{tabular}
